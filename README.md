...
<details>
<summary><strong>Oversikt over aktivitet</strong></summary>

Her kan du se alle konfigurerte appeksponeringer og hvor aktive de er (hvor lenge siden de sist mottok trafikk):  
[gui dev](https://saas-proxy.intern.dev.nav.no/internal/gui) og [gui prod](https://saas-proxy.intern.nav.no/internal/gui)

"Not seen" indikerer enten at det er en ny kobling som ennå ikke er tatt i bruk, eller at koblingen er utdatert og kan fjernes.

Hvis du fjerner en gammel kobling, husk å informere NAIS-teamet som eier appen koblingen peker til, slik at de også kan fjerne `saas-proxy` fra sin ACL.
